...
- Updated dependencies [0506038]
  - @anby/platform-sdk@1.4.1
  - @anby/manifest-schema@1.4.1
...
- Updated dependencies [00b2263]
  - @anby/platform-sdk@1.4.0
  - @anby/manifest-schema@1.4.0
...
- Updated dependencies
  ...
  - @anby/platform-sdk@1.3.0

## 1.2.0

### Minor Changes

- Linked version bump only — kept in lockstep with `@anby/manifest-schema` 1.2.0 (per-locale page labels). Apps scaffolded with `anby init` can now declare `label_<locale>` (e.g. `label_en`, `label_vi`) on each page.

### Patch Changes

- Updated dependencies
  - @anby/manifest-schema@1.2.0
  - @anby/platform-sdk@1.2.0

## 1.1.0

### Minor Changes

- Linked version bump only; rode along with platform-sdk multi-issuer/signServiceToken release.
