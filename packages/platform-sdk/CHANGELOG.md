...
- Linked version bump only — kept in lockstep with `@anby/manifest-schema` 1.2.0 (per-locale page labels). Sidebar consumers can now read `ResolvedPage.labels` directly from the SDK re-export of the manifest types.

### Patch Changes

- Updated dependencies
  - @anby/manifest-schema@1.2.0
  - @anby/contracts@1.2.0

## 1.1.0

### Minor Changes

- platform-sdk: MultiIssuerVerifier + signServiceToken for service apps.
